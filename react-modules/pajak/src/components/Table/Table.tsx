import {DataGrid, Panel, GridColumn} from "rc-easyui";
...
const Table: React.FC<IProps> = (props: IProps) => {
    ...
    const pageOptionsSmall: any =  {
        layout: ['list', 'manual', 'refresh', 'info' ]
    };
        ...
        <div className={clsx(props.tableType, {'table-custom': !props.tableType})} style={{...props?.styles}}>
            <Panel title={props.title}>
                <DataGrid
                    ...
                    pageOptions={props?.paginationOptions === 'small' ? pageOptionsSmall : pageOptions}
                ...
                >
                    {props.columns.map((item: any, index: number) => {
                        ...
                        <GridColumn key={index}
                            ...
                            width={item?.width}
                            align={item?.align}
                            header={() => <div style={{ textAlign: 'center' }}>{item?.title}</div>} 
                            editable={item?.editable}
                            editor={item?.editor}
                            editRules={item?.editRules}
                            render={item?.render}

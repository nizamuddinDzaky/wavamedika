...
interface IProps {
    ...
    onSelect?: (params: detailDataPajakKaryawan) => void;
...
const ListKaryawan: React.FC<IProps> = (props: IProps) => {
    ...
    const [data, setData] = useState<Array<detailDataPajakKaryawan>>(dataDummy);
    const [meta, setMeta] = useState<Metadata>({});
    const [mode, setMode] = useState<string>('');
    const [selection, setSelection] = useState<detailDataPajakKaryawan>({});
    ...
    const onSelectionChange = useCallback((e: detailDataPajakKaryawan) => {
        setSelection(e);

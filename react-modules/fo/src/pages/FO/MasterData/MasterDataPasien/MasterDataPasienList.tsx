...
import IndeksPasien from './IndeksPasien/IndeksPasien';
...
const MasterDataPasienList: React.FC<IProps> = (props: IProps) => {
    ...
    const pesanPoliRef: any = useRef(null);
    const infoPasienRef: any = useRef(null);
    const indeksPasienRef: any = useRef(null);
    ...
    return(
        <>
            ...
            >
                {
                    pesanPoliRef.current && selection?.id_mr &&
                        <PesanPoli
                            id_mr={selection.id_mr}
                        ></PesanPoli>
                }
            ...
            >
                {
                    indeksPasienRef.current && <IndeksPasien
                        id_mr={selection?.id_mr? selection.id_mr: 0}
                    />
                }
            </CustomDialog>
            <Table

...
const MasterDataAsuransi_FormAdmission: React.FC<propTypes> = (props: propTypes) => {
    ...
    return (
        <DetailPageWrapper
            backLink={'/fo/master-data/admission/data-admission'}
            headerRightToolbar={
                <>
                    <>
                        &nbsp;
...
export default withRouter(MasterDataAsuransi_FormAdmission);
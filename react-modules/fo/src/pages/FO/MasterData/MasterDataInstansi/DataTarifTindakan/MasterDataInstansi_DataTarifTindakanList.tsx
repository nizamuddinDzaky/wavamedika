...
const MasterDataInstansi_DataTarifTindakanList: React.FC<IProps> = (props: IProps) => {
    ...
    const getData = async (limit?: number, page?: number ) => {
        try {
            ...
            const resp = await master_instansiService.mkt_masterinstansi_masterinstansitarif(payload);
    ...
    const onEditEnd = async (event: any) => {
        try {
            ...
            if(mode === 'add') {
                ...
                const resp = await master_instansiService.mkt_masterinstansi_insert_instansitarif(payload);
    ...
    const handleDelete = async () => {
        try {
            ...
            const resp = await master_instansiService.mkt_masterinstansi_delete_instansitarif(payload);
    ...
    return(
        <>
            ...
            <Table
                isLazy
                title={`Data Tarif Tindakan Instansi: ${props.kode_instansi}`}
...
export default withRouter(MasterDataInstansi_DataTarifTindakanList);
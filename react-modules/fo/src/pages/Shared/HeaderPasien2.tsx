...
const HeaderPasien2: React.FC<IProps> = (props: IProps) => {
    ...
    const getPasienData = useCallback(async () => {
        try {
            ...
            resp = await dataPasienService.tpp_datapasien_view_datapasien({id_mr: props.idMR});
    ...
    return(
        <div className="kt-widget1 col-lg-12" style={props.style}>
            {!loading ?

...
import {detailDataFaktur} from "../../../../pojo/entry/terima_sampel/cari_billing/list_faktur";
...
interface IPropsCariBilling {
    hidePagination?: boolean;
}

const CariBilling = (props: IPropsCariBilling) => {
    ...
    const [tanggalAkhir, setTanggalAkhir] = useState<string>(moment().format('YYYY-MM-DD'));
    ...
    const [data, setData] = useState<Array<detailDataFaktur>>(dataDummyTerimaSampel);
    const [meta, setMeta] = useState<Metadata>({});
    const [mode, setMode] = useState<string>('');
    const [selection, setSelection] = useState<detailDataFaktur>({});
    ...
    return(
        <div className={'kt-portlet kt-portlet--height-fluid kt-portlet--mobile'}>
            ...
            <div className={'kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm'}>
                ...
                >
                    <div className={'col-xl-4 col-lg-6'}>
                        <h4 className={'kt-margin-b-20'}>Pencarian Data Pasien:</h4>
            ...
            <div className={'kt-portlet__body kt-portlet__body--fit kt-margin-b-20 kt-margin-t-50'}>
                <Table
                    height={450}
                    disableNumber

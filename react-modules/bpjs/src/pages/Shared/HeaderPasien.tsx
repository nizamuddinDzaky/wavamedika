...
import {detail} from "../../pojo/master/data_pasien/data_riwayat_pasien";
...
const HeaderPasien: React.FC<IProps> =(props: IProps) => {
    ...
    const getPasienData = useCallback(async () => {
        try {
            ...
            resp = await dataRiwayatPasienService.tpp_riwayatpasien_view_datapasien_riwayat({id_mr: props.idMR});
            // if(!props?.isPMKP)

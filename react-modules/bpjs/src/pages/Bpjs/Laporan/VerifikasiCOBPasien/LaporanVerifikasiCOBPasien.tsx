...
import { detailDataVerifikasiCOBPasien } from '../../../../pojo/laporan/verifikasi_cob_pasien/data_verifikasi_cob_pasien';
...
interface IPropsLaporanVerifikasiCOBPasien {
...
const LaporanVerifikasiCOBPasien = (props: IPropsLaporanVerifikasiCOBPasien) => {
    let {
        hidePagination
    } = props;

    const [loading, setLoading] = useState<boolean>(false);
    const [data, setData] = useState<Array<detailDataVerifikasiCOBPasien>>(dataDummy);
    const [meta, setMeta] = useState<Metadata>({});
    const [mode, setMode] = useState<string>('');
    const [selection, setSelection] = useState<detailDataVerifikasiCOBPasien>({});
        ...
        <div className={'kt-portlet kt-portlet--height-fluid kt-portlet--mobile'}>
            ...
            <div className={'kt-portlet__body kt-portlet__body--fit kt-margin-b-20 kt-margin-t-20'}>
                <Table
                    height={450}
                    disableNumber
                    title={'List Verifikasi Invoice Pasien Kerjasama'}
...
export default LaporanVerifikasiCOBPasien
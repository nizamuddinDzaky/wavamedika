...
import { detailDataNotifikasiKRSPasien } from '../../../../pojo/laporan/notifikasi_krs_pasien/data_notifikasi_krs_pasien';
...
interface IPropsLaporanNotifikasiKRSPasien {
...
const LaporanNotifikasiKRSPasien = (props: IPropsLaporanNotifikasiKRSPasien) => {
    let {
        hidePagination
    } = props;

    const [loading, setLoading] = useState<boolean>(false);
    const [data, setData] = useState<Array<detailDataNotifikasiKRSPasien>>(dataDummy);
    const [meta, setMeta] = useState<Metadata>({});
    const [mode, setMode] = useState<string>('');
    const [selection, setSelection] = useState<detailDataNotifikasiKRSPasien>({});
...
export default LaporanNotifikasiKRSPasien
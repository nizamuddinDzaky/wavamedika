...
const MasterReaksiAlergi = (props: IPropsMasterReaksiAlergi) => {
    ...
    const [data, setData] = useState<Array<detailDataReaksiAlergi>>(dataDummy);
    const [meta, setMeta] = useState<Metadata>({});
    const [mode, setMode] = useState<string>('');
    const [selection, setSelection] = useState<detailDataReaksiAlergi>({});
    ...
    //         };
            ...
            setData(newData);
            setLoading(false);
            NotifySuccess('Data Reaksi Alergi Berhasil Dihapus');
         } catch(e) {
             console.log('error', e);
             setLoading(false);
         }
    ...
    const onEditEnd = async (event: any) => {
        try {
            ...
            if(mode === 'add') {
                ...
                setMode('');
                setLoading(false);
                NotifySuccess('Data Reaksi Alergi Berhasil Ditambahkan');
                ...
                setMode('');
                setLoading(false);
                NotifySuccess('Data Reaksi Alergi Berhasil Diubah');

...
const MasterDaftarPelayanan = (props: IPropsMasterDaftarPelayanan) => {
    ...
    const dataDummy = [
        {
            id: 1,
            nama_layanan: 'ACA lg A',
            metode : 'ELISA' 
        },
        {
            id: 2,
            nama_layanan: 'ACA lg B',
            metode : 'ELISU' 
        },
        {
            id: 3,
            nama_layanan: 'ACA lg C',
            metode : 'ELISE' 
        },
    ...
    const [data, setData] = useState<Array<detailDataPelayanan>>(dataDummy);
        ...
        try {
            ...
            if(mode === 'add') {
                ...
                const payload = {
                    ...
                    nama_layanan: event?.row?.nama_layanan,

...
class Retur_pembelian extends CI_Controller {
	...
	{
		$this->data['js'] = 'transaksi/retur_pembelian_js';
        $this->data['main_view'] = 'transaksi/v_retur_pembelian';
    ...
    public function simpan()
    {
        ...
        if($_POST['edit']==0)
        {
            $API=BASE_URL_API_LPS.'pembelian/umum/retur_beli/insert';
        }
        else
        {
            $API=BASE_URL_API_LPS.'pembelian/umum/retur_beli/update';   
        }
        // echo $API;die;
        // var_dump($data); die();
    ...
    public function filter()
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'pembelian/umum/retur_beli/search');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);
        curl_setopt($curl_handle, CURLOPT_POSTFIELDS,json_encode($data));
    ...
    {
        $API = BASE_URL_API_LPS.'pembelian/umum/retur_beli/get/'.$_POST['data'];
        $headers=getHeaderToken();
...
/* Location: ./application/apps/general/controllers/transaksi/Retur_pembelian.php */
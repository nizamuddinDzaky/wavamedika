...
class Pemakaian_depo extends CI_Controller {
	...
	{
		$this->data['js'] = 'transaksi/pemakaian_depo_js';
        $this->data['main_view'] = 'transaksi/v_pemakaian_depo';
	...
	public function filter()
    {
        ...
        $param['criteria']   = $param['criteria'] ?? '';
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'depo_umum/pemakaian_depo/search');
    ...
    {
        $API = BASE_URL_API_LPS.'depo_umum/pemakaian_depo/get/'.$_POST['data'];
        $headers=getHeaderToken();
    ...
    public function simpan()
    {
        ...
        if($_POST['edit']==0)
        {
            $API=BASE_URL_API_LPS.'depo_umum/pemakaian_depo/insert';
        }
        else
        {
            $API=BASE_URL_API_LPS.'depo_umum/pemakaian_depo/update';   
        }
    ...
    public function hapus()
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'depo_umum/pemakaian_depo/delete');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);
        curl_setopt($curl_handle, CURLOPT_POSTFIELDS,json_encode($_POST['data']));
    ...
    public function user_approve($seq_no)
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'depo_umum/pemakaian_depo/list_user_approve');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);
        curl_setopt($curl_handle, CURLOPT_POSTFIELDS,json_encode($data));
    ...
    public function status()
    {
        ...
        if($_POST['status']==1)
        {
            $API=BASE_URL_API_LPS.'depo_umum/pemakaian_depo/status/open';
        }
        else if($_POST['status']==2)
        {
            $API=BASE_URL_API_LPS.'depo_umum/pemakaian_depo/status/release';   
        }
        else if($_POST['status']==3)
        {
            $API=BASE_URL_API_LPS.'depo_umum/pemakaian_depo/status/receive';   
        }
        else if($_POST['status']==4)
        {
            $API=BASE_URL_API_LPS.'depo_umum/pemakaian_depo/status/reject';   
        }
...
/* End of file Pemakaian_depo.php */
/* Location: ./application/apps/general/controllers/transaksi/Pemakaian_depo.php */
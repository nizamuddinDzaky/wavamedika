...
class Pembelian_tunai extends CI_Controller {
	...
	{
		$this->data['js'] = 'transaksi/pembelian_tunai_js';
        $this->data['main_view'] = 'transaksi/v_pembelian_tunai';
...
/* Location: ./application/apps/general/controllers/transaksi/Pembelian_tunai.php */
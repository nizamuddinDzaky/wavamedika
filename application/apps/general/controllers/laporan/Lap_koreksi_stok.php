...
class Lap_koreksi_stok extends CI_Controller {
    ...
    {
        $this->data['js'] = 'laporan/lap_koreksi_stok_js';
        $this->data['main_view'] = 'laporan/v_lap_koreksi_stok';
    ...
    public function filter()
    {
        ...
        $url = BASE_URL_API_LPS.'laporan/koreksi_stok/umum/'.$param['url'];
        // echo $url;die;
    ...
    public function get_data_unit()
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'master/list_unit_stok/umum');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);

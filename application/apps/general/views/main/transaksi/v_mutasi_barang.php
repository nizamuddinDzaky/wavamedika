...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Mutasi Barang</h3>
...
<div class="kt-container kt-container-form kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
            ...
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                <div class="table-custom">
                    <table id="dtg-mutasi_barang" height="500" width="100%" title="Daftar Mutasi Barang" class="easyui-datagrid" toolbar="#toolbar" pagination="true" rownumbers="true" singleSelect="true">
                        <thead>
                            <tr>
                                <th halign="center" align="left" field="no_mutasi" width="15%" >No. Permintaan</th>
                                <th halign="center" field="tgl_mutasi" width="13%" data-options="formatter:appGridDateFormatter" align="center">Tgl. Permintaan</th>
                                <th halign="center" field="unit_stok" width="13%" >Unit Asal</th>
                                <th halign="center" field="unit_tujuan" width="15%" >Unit Tujuan</th>
                                <th halign="center" field="jns_mutasi" width="8%" >Jenis</th>
                                <th halign="center" field="ket_mutasi" width="25%" >Catatan</th>
                                ...
                                <th halign="center" field="date_ins" width="12%" data-options="formatter:appGridDateTimeFormatter" align="center">Tgl. Dibuat</th>
                                <th halign="center" align="left" field="updated_by" width="10%" >Diubah Oleh</th>
                                <th halign="center" align="center" field="date_upd" width="12%" data-options="formatter:appGridDateTimeFormatter" align="center">Tgl. Diubah</th>
                            </tr>
                        </thead>
                    </table>
                    <div id="toolbar">
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
            <div class="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
                <form class="kt-form col-lg-12 header-form kt-margin-t-25" id="form-header" style="">
                                ...
                                <div class="col-lg-auto kt-padding-t-10-mobile">
                                    <div class="form-group row" id="btn-aksi">
                                        <div style="padding: 2px" class="col-lg-auto kt-padding-t-10-mobile">
                                            <button id="btn-open" type="button" class="form-control form-control-sm btn btn-sm btn-primary" >
                                                <i class=""></i>
                                                Open
                                            </button>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group row">
                               ...
                               <div class="col-lg-3 col-sm-12 status_caption">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    <input class="form-control form-control-sm" type="text" disabled="true" id="txt-unit_tujuan">
                                    <input class="form-control form-control-sm" type="text" disabled="true" id="txt-unit_tujuan_id" hidden>
                                    <input class="form-control form-control-sm" type="text" disabled="true" id="txt-jenis_mutasi" hidden>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="row" title="Detail Mutasi Barang" style="margin-top: 10px;">
                        <div class="col-12 table-detail">
                            <table id="dtg-detail_item" height="200" width="100%" class="easyui-datagrid" toolbar="#toolbarDetailA" pagination="false" rownumbers="true" singleSelect="true" fitColumns="false">
                                <thead>
                                    <tr>
                                        <th halign="center" align="right" field="kode" width="100" hidden>Kode</th>
                            ...
                            <table id="dtg-autorisasi" height="150" width="100%" title="Autorisasi" class="easyui-datagrid" toolbar="#toolbarDetailB" pagination="false" rownumbers="true" singleSelect="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th halign="center" align="left" field="status_caption" width="100" >Status</th> 
                                        ...
                                        <th halign="center" align="left" field="is_active" width="100"></th>
                                        <th halign="center" align="left" field="user_id_approve" width="100"></th>
    ...
    <div id="win-cari_no_permintaan" class="panel-window" data-title="Pencarian Data Item" style="width: 80%; height: 83%">
        <div class="kt-portlet-win">
            <div class="kt-portlet__body_win header-form">
                <div class="col-lg-6">
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2 col-sm-12 form-control-sm kt-font-sm" style="margin-left: 10px;">
                            Kriteria :
                        </label>
                        <div class="col-lg-7 col-sm-12">
                            <input name="searchText" class="form-control form-control-sm" type="text" id="txt-kriteria_barang_all" placeholder="Cari...">
                        </div>
                            ...
                            <table id="dtg-list_barang" height="150" width="100%" class="easyui-datagrid" pagination="false" singleSelect="true">
                                <thead>
                                    <tr>
                                      ...
                                      <th halign="center" align="left" field="unit_asal"  width="135">Lokasi</th>
                                      <th halign="center" align="left" field="jns_mutasi" width="105">Jenis Permintaan</th>
                                      <th halign="center" align="left" field="created_by" width="110">Yang Mengajukan</th>
                                    </tr>
                                </thead>
                            </table>
                            <div class="col-lg-12" style="background-color: #0F9E98">
                                <label class="col-form-label col-lg-12 col-sm-12 form-control-sm kt-font-sm" align="center" style="color: white"><b>Detail Permintaan Mutasi</b></label>
                            </div>
                            <table id="dtg-list_barang_detail" height="150" width="100%" class="easyui-datagrid" pagination="false" singleSelect="true">
                                <thead>
                                    <tr>
                                      <th halign="center" align="left" field="nama_item" width="400">Nama Item</th>
                                      <th halign="center" align="center" field="kd_item" width="15%">Kode</th>
                                      ...
                                      <th halign="center" align="right" field="jml_mutasi" width="15%" data-options="formatter:appGridNumberFormatter">Jml. Pemakaian Ruang</th>
                                      <th halign="center" align="right" field="jml_ss" width="15%" data-options="formatter:appGridNumberFormatter">Safety Stok</th>
                                      <th halign="center" align="right" field="jml_rekam_order" width="15%" data-options="formatter:appGridNumberFormatter">Rop</th>

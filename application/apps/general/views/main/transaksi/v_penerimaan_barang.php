...
<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Penerimaan Barang General</h3>
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-lg-5">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-sm-12">
                                    <textarea class="form-control form-control-sm kt-font-sm" style="resize: none; height: 100px;" id="txt-keterangan"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="form-group row">
                                ...
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm kt-font-sm" style="padding-left: 35px; padding-right: 1px;">
                                    Diskon Nota :
                                </label>
                                <div class="col-lg-3 col-sm-12">

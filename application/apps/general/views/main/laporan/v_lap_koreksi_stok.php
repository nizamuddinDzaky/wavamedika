...
<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Laporan Koreksi Stok</h3>
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="" class="kt-subheader__breadcrumbs-link">Koreksi Stok</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
            <div class="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
                <form class="kt-form col-lg-12 header-form kt-margin-t-25" id="form-header">
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12 col-md-4 col-sm-12 kt-margin-t-10-mobile" style="margin-left: 2px;">
                                    <select class="form-control form-control-sm change" multiple="true" id="cmb-jenis_laporan" style="height: 175px;">
                                        <option value="so_nota" selected>Koreksi Stok Per No. Stok Opname</option>
                                        <option value="so_item">Koreksi Stok Per Item</option>
                                        <option value="so_rekap">Rekap Koreksi Stok</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row custom-radio">
                                <label class="kt-checkbox--success form-control-sm">
                                    <input id="chk-is_aktif" name="chk-is_aktif" type="checkbox">   Unit/Depo :
                                </label>
                                <div class="col-lg-7 col-md-4 col-sm-12" style="margin-left: 13px;">
                                    <select class="select2 form-control form-control-sm change" id="cmb-unit">
                                        <!--  -->
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-auto col-md-2 col-sm-12 kt-margin-t-10-mobile" style="margin-left: -5px; margin-top: 0px;">
                ...
                <form action="" method="post" id="form_excel" hidden="true">
                    <div>
                        ...
                        <input type="text" id="id_unit" name="id_unit">
                    </div> 
                </form>
            </div>
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                ...
                <div class="table-custom" id="tbl1">
                    <table id="dtg1" height="500" width="100%" title="Koreksi Stok Per No. Stok Opname" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true">
                        <thead>
                            <tr>
                                <th halign="center" align="center" field="periode" width="10%">Periode</th>
                                <th halign="center" align="center" field="no_so" width="12%">N0. SO</th>
                                <th halign="center" align="left" field="nama_unit" width="15%">Unit/Depo</th>
                                <th halign="center" align="left" field="nama_pj" width="18%">Penanggung Jawab</th>
                                <th halign="center" align="left" field="catatan" width="20%">Catatan</th>
                                <th halign="center" align="center" field="user_fullname" width="12%">User</th>
                                <th halign="center" align="center" field="date_upd" width="12%" data-options="formatter: appGridDateTimeFormatter">Tgl. Diubah</th>
                            </tr>
                        </thead>
                    </table>
                </div>
                ...
                <!--Start Koreksi Stok Per Item-->
                <div class="table-custom" id="tbl2">
                    <table id="dtg2" height="500" width="100%" title="Koreksi Stok Per Item" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true" >
                        <thead>
                            <tr>
                            ...
                            <tr>
                                <th halign="center" align="left" field="periode" width="12%">Periode</th>
                                <th halign="center" align="left" field="no_so" width="12%">N0. SO</th>
                                <th halign="center" align="left" field="nama_unit" width="12%">Unit</th>
                                ...
                                <th halign="center" align="right" field="jml_sistem" width="10%" data-options="formatter: appGridNumberFormatter">Jml. Sistem</th>
                                <th halign="center" align="right" field="jml_fisik" width="10%" data-options="formatter: appGridNumberFormatter">Jml. Fisik</th>
                                <th halign="center" align="right" field="jml_selisih_lebih" width="12%" data-options="formatter: appGridNumberFormatter">Jml. Selisih Lebih</th>
                                <th halign="center" align="right" field="jml_selisih_kurang" width="12%" data-options="formatter: appGridNumberFormatter">Jml. Selisih Kurang</th>
                                <th halign="center" align="right" field="nama_ket_selisih" width="15%">Keterangan</th>

                                <th halign="center" align="right" field="hpp" width="10%" data-options="formatter: appGridNumberFormatter">HPP</th>
                                <th halign="center" align="right" field="nilai_selisih_lebih" width="15%" data-options="formatter: appGridNumberFormatter">Nilai Selisih Lebih</th>
                                <th halign="center" align="right" field="nilai_selisih_kurang" width="15%" data-options="formatter: appGridNumberFormatter">Nilai Selisih Kurang</th>

                                <th halign="center" align="right" field="user_fullname" width="12%">Dibuat Oleh</th>
                                <th halign="center" align="right" field="tgl_so_det" width="10%">Tgl. SO</th>
                            </tr>
                        </thead>
                    </table>
                </div>
                <!--End Koreksi Stok Per Item-->

                <!--Start Rekap Koreksi Stok -->
                <div class="table-custom" id="tbl3">
                    <table id="dtg3" height="500" width="100%" title="Rekap Koreksi Stok" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true">
                        <thead>
                            <tr><th halign="center" align="left"width="18%" field="nama_unit">Depo/Unit</th>
                                ...
                                <th halign="center" align="center" width="10%" field="jenis">Jenis</th>
                                <th halign="center" align="right" width="12%" field="jml_selisih_lebih" data-options="formatter: appGridNumberFormatter">Selisih SO Lebih</th>
                                <th halign="center" align="right" width="12%" field="jml_selisih_kurang" data-options="formatter: appGridNumberFormatter">Selisih SO Kurang</th>
                                <th halign="center" align="right" width="15%" field="nilai_selisih_lebih" data-options="formatter: appGridNumberFormatter">Nilai Koreksi Stok Lebih</th>
                                <th halign="center" align="right" width="15%" field="nilai_selisih_kurang" data-options="formatter: appGridNumberFormatter">Nilai Koreksi Stok Kurang</th>
                            </tr>
                        </thead>
                    </table>
                </div>
                <!--End Rekap Koreksi Stok-->
            </div>

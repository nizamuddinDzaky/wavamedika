...
<script type="text/javascript">
    ...
    function filter(){
        ...
        var dg = $('#dtg-daftar_supplier').datagrid({
            url        : "<?php echo base_url("general/master/supplier/filter"); ?>",
            method     : "POST",
            dataType   :'json',
            queryParams: data,
    ...
    function simpan(){
        ...
        if (partner_id == ''||partner_name == ''|| partner_address == ''|| partner_phone == ''|| partner_fax == ''|| website == ''|| contact_person == ''|| contact_person_phone == ''|| email == '')
        {
          let msg = '<br>';
        ...
        console.log(data);
        $.ajax({
            url     : "<?php echo base_url("general/master/supplier/simpan"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                edit: edit,
    ...
    function get_data(row){
        $.ajax({
            url     : "<?php echo base_url("general/master/Supplier/getSupplier"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data:row.partner_id,
    ...
    function hapus(row){
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url     : "<?php echo base_url("general/master/Supplier/hapus"); ?>",
                    type    : "POST",
                    dataType: 'json',
                    data    :{
                        data: data,

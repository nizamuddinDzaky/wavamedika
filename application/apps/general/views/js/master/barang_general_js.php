<script type="text/javascript">
    ...
    function filter(){
        ...
        var dg = $('#dtg-barang_general').datagrid({
            url     : "<?php echo base_url("general/master/barang_general/filter"); ?>",
            method  : "POST",
            dataType:'json',
                      queryParams: data,
    ...
    function filter_supplier(){
        ...
        var dg = $('#dtg-supplier').datagrid({
          	url : "<?php echo base_url("general/master/barang_general/filter_supplier"); ?>",
          	method: "POST",
          	queryParams: data,
          	loadFilter: function(data) {
            	return {
    ...
    function get_data(no){
        $.ajax({
            url     : "<?php echo base_url("general/master/barang_general/getItem"); ?>",
            type    : "POST",
            dataType: 'json',
            async   : false,
            data    :{
    ...
    function hapus()
    {
        ...
        swal.fire(cohapus()).then(function(result) {
          if (result.value) {
            $.ajax({
                url     : "<?php echo base_url("general/master/Barang_general/hapus"); ?>",
                type    : "POST",
                dataType: 'json',
                data    :{
                    data: data,
    ...
    function simpan(){
        ...
        master={
         ...
         $.ajax({
          url : "<?php echo base_url("general/master/Barang_general/simpan"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            master  : master,
    ...
    {
        $.ajax({
            url : "<?php echo base_url("general/master/barang_general/getSatuan"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    {
        $.ajax({
            url : "<?php echo base_url("general/master/barang_general/getKelompok"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },

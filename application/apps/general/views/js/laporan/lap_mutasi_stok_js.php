<script type="text/javascript">
	...
	function filter()
	{
		...
		// console.log(data);
	  	...
	  	var dg = $(tabel_utama).datagrid({
			url : "<?php echo base_url("general/laporan/Lap_mutasi_stok/filter"); ?>",
			method: "POST",
			queryParams: data,
	...
	function cetak()
	{
	    ...
	    $.ajax({
	        url     : "<?= base_url() ?>general/laporan/Lap_mutasi_stok/cetak_"+url,
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,
	...
	function set_form()
	{
		...
		var url_control = "<?= base_url() ?>general/laporan/Lap_mutasi_stok/cetak_"+url;

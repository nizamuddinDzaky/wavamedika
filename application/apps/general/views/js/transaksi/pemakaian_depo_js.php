...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#btn-ubah').click(function () {
            var row = $('#dtg-pemakaian_depo').datagrid('getSelected');
            if(row <= 0)
            {
        ...
        $('#cmb-data_unit_asal').select2({
          dropdownParent : $('#detail'),
          placeholder: 'Pilih unit'
        });
        $('#cmb-data_unit_tujuan').select2({
          dropdownParent : $('#detail'),
          placeholder: 'Pilih unit'
        });
        ...
        function show_win_src_no_permintaan() {
            var id_unit_asal  = $('#cmb-data_unit_asal option:selected').val();
            var id_unit_tujuan  = $('#cmb-data_unit_tujuan option:selected').val();
            var unit_tujuan = $('#cmb-data_unit_tujuan').select2('data')[0].text;
            if(id_unit_asal == "")
            {
            ...
            $("#txt-kriteria_barang_all").val("Unit Tujuan : "+unit_tujuan);
    ...
    function get_select()
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("general/transaksi/pemakaian_depo/get_data_unit_asal"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
            success:function(data, textStatus, jqXHR){
               $("#cmb-data_unit_asal").select2({ data: data });
            },
        ...
        $.ajax({
            url : "<?php echo base_url("general/transaksi/pemakaian_depo/get_data_unit_tujuan"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
            success:function(data, textStatus, jqXHR){
               $("#cmb-data_unit_tujuan").select2({ data: data });
            },
            error: function(jqXHR, textStatus, errorThrown){
                alert('Error,something goes wrong');
            },
    ...
    function filter()
    {
        $('#dtg-pemakaian_depo').datagrid('loadData',[]);
        ...
        // $.ajax({
        //   url : "<?php echo base_url("farmasi/depo/pemakaian_depo/filter"); ?>",
        //   type: "POST",
        //   dataType: 'json',
        //   data:{
        //     data: data,
        ...
        //     }
        //     $('#dtg-pemakaian_depo').datagrid('loadData', data.list);
        //   },
        //   error: function(jqXHR, textStatus, errorThrown){
        //       alert('Error,something goes wrong');
        //   },
        ...
        var dg = $('#dtg-pemakaian_depo').datagrid({
          url : "<?php echo base_url("general/transaksi/pemakaian_depo/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_barang()
    {
        ...
        var id_unit_stok = $('#cmb-data_unit_asal option:selected').val();
        ...
        $.ajax({
          url : "<?php echo base_url("general/transaksi/pemakaian_depo/Filter_barang_no_mutasi"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
        ...
        //   url : "<?php echo base_url("farmasi/depo/pemakaian_depo/Filter_barang_no_mutasi"); ?>",
        //   method: "POST",
        //   queryParams: data,
        //   loadFilter: function(data) {
        //     // if (data.metadata.list_count<1)
    ...
    function filter_barang_all()
    {
        ...
        var dg = $('#dtg-list_barang').datagrid({
          url : "<?php echo base_url("general/transaksi/pemakaian_depo/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            // if (data.metadata.list_count<1)
    ...
    {
        $.ajax({
          url : "<?php echo base_url("general/transaksi/pemakaian_depo/getPerKode"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: no_mutasi,
    ...
    function set_data(data)
    {
        ...
        $('#cmb-data_unit_asal').val(data.master.id_unit_stok).change();
        $('#cmb-data_unit_tujuan').val(data.master.id_unit_tujuan).change();
        ...
        $('#cmb-data_unit_asal').attr('disabled', true);
    ...
    function set_read(kondisi)
    {
        ...
        $('#cmb-data_unit_asal').attr('disabled', kondisi);
        ...
        {
          $('#div_status').hide();
          $('#cmb-data_unit_asal').prop('disabled', false);
          $('#btn-aksi').hide();
          $('#div_hapus').hide();
          $('#btn-cetak').hide();
        }
        ...
        {
          $('#div_status').show();
          $('#cmb-data_unit_asal').prop('disabled', true);
          $('#btn-aksi').show();
          $('#div_hapus').show();
          $('#btn-cetak').show(); 
        }
    ...
    $('#dtg-detail_item').datagrid({
      ...
      columns:[[
        ...
        {
            field:'jml_mutasi',title:'Jml. Keluar',width:100,halign :"center",align:"right",formatter: appGridNumberFormatter
        },
        {
    ...
    function simpan()
    {
        ...
        var id_unit_asal   = $('#cmb-data_unit_asal option:selected').val();
        var id_unit_tujuan = $('#cmb-data_unit_asal option:selected').val();
        ...
        for (var i=0; i<row.length; i++) {
          details.push({
            ...
            jml_sisa  : row[i]['minta']-row[i]['jml_mutasi'],
            hpp       : row[i]['hpp'],
        ...
        $.ajax({
          url : "<?php echo base_url("general/transaksi/pemakaian_depo/simpan"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function hapus(no_pp)
    {
        ...
        "customClass"      : {
          ...
          "cancelButton"     : "btn-secondary"
            ...
            if (result.value) {
                    $.ajax({
                      url : "<?php echo base_url("general/transaksi/pemakaian_depo/hapus"); ?>",
                      type: "POST",
                      dataType: 'json',
                      data:{
                        data: data,
    ...
    function verifikasi(data,status)
    {
      ...
      $.ajax({
        url : "<?php echo base_url("general/transaksi/pemakaian_depo/status"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: data,

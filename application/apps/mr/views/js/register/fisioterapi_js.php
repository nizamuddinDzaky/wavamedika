<script type="text/javascript">
    ...
    $('#dtg2').datagrid({
        ...
        columns:[[
            ...
            {field:'cara_masuk',title:'Cara Masuk',width:"15%",halign:'center',align:'left'},
            {field:'kunjungan',title:'Kunj MRS',width:"15%",halign:'center',align:'left'},
            {field:'kunjungan_unit',title:'Dari Unit',width:"15%",halign:'center',align:'left'},
            {field:'uraian',title:'Tindakan',width:"15%",halign:'center',align:'left'},
    ...
    function filter()
    {
        ...
        var dg = $(tabel_utama).datagrid({
            url : "<?php echo base_url("mr/register/fisioterapi/filter"); ?>",
            method: "POST",
            queryParams: data,

<script type="text/javascript">
	...
	var title_datagrid = "Daftar Jenis Pemeriksaan Laboratorium";
      ...
      columns:[[
        ...
        formatter:function(value,row){
            ...
            options:{
                ...
                valueField:'jenis',
                textField :'jenis',
                url       :'<?php echo base_url("mr/master/jenis_pemeriksaan_laboratorium/list_jenis") ?>',
                required  :true
            }
            }
        }
	...
	function filter()
	{
		...
		$.ajax({
			url     : "<?php echo base_url("mr/master/jenis_pemeriksaan_laboratorium/filter"); ?>",
			type    : "POST",
			dataType: 'json',
	...
	{
        $.ajax({
			url     : "<?php echo base_url("mr/master/jenis_pemeriksaan_laboratorium/simpan"); ?>",
			type    : "POST",
			dataType: 'json',
			data    :{
				edit: edit,
	...
	{   
        ...
        $.ajax({
			url     : "<?php echo base_url("mr/master/jenis_pemeriksaan_laboratorium/hapus"); ?>",
			type    : "POST",
			dataType: 'json',
			data    :{
				data: data,

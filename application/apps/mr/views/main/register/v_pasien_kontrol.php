        ...
        <div class="row col-lg-12 justify-content-between">
            <div class="col-lg-auto">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Pasien Kontrol</h3>
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="" class="kt-subheader__breadcrumbs-link">Pasien Kontrol</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm">Dokter :</label>
                                <div class="col-lg-3 col-md-4 col-sm-12">
                                    <select class="select2 form-control" id="cmb-data_dokter">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm">Kontrol :</label>
                                <div class="col-lg-3 col-md-4 col-sm-12">
                                    <select class="form-control form-control-sm" id="cmb-kontrol">
            ...
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                <div class="table-custom" id="tbl1">
                    <table id="dtg1" height="500" width="100%" title="Daftar No. RM" class="easyui-datagrid" rownumbers="true" pagination="true">
                        <!--  -->
                    </table>
                </div>

                <div class="table-custom" id="tbl2">
                    <table id="dtg2" height="500" width="100%" title="Daftar No. RM" class="easyui-datagrid" rownumbers="true" pagination="true">
                        <!--  -->
                    </table>
                </div>
            </div>

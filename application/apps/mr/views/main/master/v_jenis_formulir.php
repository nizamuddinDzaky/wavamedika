...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Jenis Formulir</h3>
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="" class="kt-subheader__breadcrumbs-link">Jenis Formulir</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                ...
                <form class="kt-form col-lg-12 header-form kt-margin-t-25" id="form-header">
                    ...
                    <div class="form-group row">
                        <label class="kt-checkbox--success form-control-sm col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <input id="chk-is_aktif" name="chk-is_aktif" type="checkbox" checked> Formulir Aktif
                        </label>
                    </div>
                </form>
            </div>
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                <div class="table-custom">
                    <table id="dtg-jenis_formulir" title="Daftar Jenis Formulir" class="easyui-datagrid" style="width: 100%;height:480px;" toolbar="#toolbar" pagination="false" idField="id" rownumbers="true" fitColumns="false" singleSelect="true" autoRowHeight="true" nowrap="false">

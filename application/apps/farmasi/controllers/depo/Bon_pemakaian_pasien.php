...
class Bon_pemakaian_pasien extends CI_Controller {
	...
	{
        $this->data['js'] = 'depo/bon_pemakaian_pasien_js';
        $this->data['main_view'] = 'depo/v_bon_pemakaian_pasien';
        $this->load->view('template', $this->data);
	}

    public function get_konfigurasi()
    {
        $API = BASE_URL_API_LPS."config/bon_pasien";
    ...
    public function filter()
    {
        ...
        $headers  = getHeaderToken();
        $curl_handle = curl_init();
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'depo_farmasi/nota/bon_pasien');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_CUSTOMREQUEST, "GET");
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);
    ...
    {
        $API = BASE_URL_API_LPS."depo_farmasi/nota/bon_pasien/".$_POST['data'];
    ...
    public function simpan()
    {
        ...
        $url = BASE_URL_API_LPS.'depo_farmasi/nota/bon_pasien';
...
/* End of file Bon_pemakaian_pasien.php */
/* Location: ./application/apps/farmasi/controllers/depo/Bon_pemakaian_pasien.php */
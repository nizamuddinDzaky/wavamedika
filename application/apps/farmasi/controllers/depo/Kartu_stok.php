...
class Kartu_stok extends CI_Controller {
    ...
    function get_data_unit()
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'master/unit_akses/list_depo_farmasi');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);
            ...
            $i=0;
                $hue.='<table class="atas" cellspacing="0" style="width: 100%;">
                    ...
                    $hue.='<tr>
                        ...
                        <th align="left"   width="30%">'.$key['nama_item']. '</th>
                        <th align="left"   width="10%">'.$key['nama_kel_item']. '</th>
                        <th align="left"   width="8%">'.$key['nama_satuan']. '</th>
                        <th align="left"   width="8%">'.$key['nama_bentuk_sd']. '</th>
                        <th align="right"  width="8%">'.angka($key['stok_awal']).'</th>
                        <th align="right"  width="8%">'.angka($key['masuk']).'</th>
                        <th align="right"  width="8%">'.angka($key['keluar']).'</th>
                        <th align="right" width="8%">'.angka($key['stok_akhir']).'</th>
                    </tr>'; 
                    $no++;
                    }
                    $hue.='</table>
...
/* Location: ./application/apps/farmasi/controllers/depo/Kartu_stok.php */
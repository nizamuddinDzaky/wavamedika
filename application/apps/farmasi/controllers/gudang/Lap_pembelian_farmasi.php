...
class Lap_pembelian_farmasi extends CI_Controller {
   var $myArray= [];
	...
	public function index()
	{
        ...
        $this->data['js'] = 'gudang/lap_pembelian_farmasi_js';

        // data['main_view] digunakan untuk mengambil isi dari content body, file disimpan di views/main
        $this->data['main_view'] = 'gudang/v_lap_pembelian_farmasi';
    ...
    function url_cetak($lap){
        $url="";
        if($lap==1){
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/minta_beli_nota';
        }elseif ($lap==2) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/minta_beli_item';
        }elseif ($lap==3) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/terima_beli_nota';
        }elseif ($lap==4) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/terima_beli_item';
        }elseif ($lap==5) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/beli_tunai_nota';
        }elseif ($lap==6) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/beli_tunai_item';
        }elseif ($lap==7) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/terima_donasi_nota';
        }elseif ($lap==8) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/terima_donasi_item';
        }elseif ($lap==9) {
            $url=BASE_URL_API_LPS.'laporan/pembelian/farmasi/ppn_masukan';
        }
        return $url;
    }

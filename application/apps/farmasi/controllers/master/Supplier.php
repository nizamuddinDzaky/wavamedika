...
class Supplier extends CI_Controller {
    ...
    public function filter()
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'master/supplier/search');
    ...
    public function simpan(){
        ...
        if($_POST['edit']==0){
            $API_SUPPLIER=BASE_URL_API_LPS.'master/supplier/insert';
        }else{
    ...
    public function getSupplier(){
        $API_Supplier = 'http://36.92.178.100/api.mersi-hospital/dev/lps/public/master/supplier/get/'.$_POST['data'];
        $headers=getHeaderToken();

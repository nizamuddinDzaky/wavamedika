...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Golongan</h3>
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="" class="kt-subheader__breadcrumbs-link">Golongan</a>
            </div>
        </div>
    </div>
</div>
...
<div class="kt-container kt-container-form kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                ...
                <form class="kt-form col-lg-12 header-form kt-margin-t-25" id="form-header">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-1 col-sm-12 kt-margin-t-20-mobile">
                            <button id="btn-filter" type="button" plain="true" class="easyui-linkbutton btn-primary" onclick="filter();">
            ...
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                <div class="table-custom">
                    <table id="dtg-golongan" style="width: 100%;height:480px; margin-top:5px" title="Daftar Golongan Obat" class="easyui-datagrid" toolbar="#toolbar" pagination="true" idField="id" rownumbers="true" fitColumns="false" singleSelect="true" autoRowHeight="true" nowrap="false">
    ...
    <div id="win" class="panel-window" data-title="Tambah Golongan Obat" style="width: 35%; height: 38%;">

...
<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Laporan Pembelian Non Formularium</h3>
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="" class="kt-subheader__breadcrumbs-link">Laporan Pembelian Non Formularium</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
            ...
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                ...
                <div class="table-custom" id="tbl1">
                    <table id="dtg1" height="500" width="100%" title="Daftar Laporan Pembelian Non Formularium" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true" fitColumns="false">
                        <thead>
                            <tr>
                                <th halign="center" align="center" field="kd_item" width="10%">Kode</th>
                                <th halign="center" align="left" field="nama_item" width="20%">Nama Obat/Alkes</th>
                                ...
                                <th halign="center" align="left" field="id_dokter" width="15%">ID Dokter</th>
                                <th halign="center" align="left" field="nama_dokter" width="25%">Nama Dokter</th>
                            </tr>
                        </thead>
                    </table>
                </div>

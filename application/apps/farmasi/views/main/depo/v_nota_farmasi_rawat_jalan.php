        ...
        <div class="row col-lg-12 justify-content-between">
            <div class="col-lg-auto">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Nota Farmasi Rawat Jalan</h3>
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="" class="kt-subheader__breadcrumbs-link">Nota Farmasi Rawat Jalan</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-sm-12" style="padding-left: 0px;">
                                    <input id="txt-no_billing" class="form-control form-control-sm" type="number" value="200805696">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8" style="margin-top: 5px;">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2 col-sm-12" style="margin-left: 45px;">
                                ...
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm kt-font-sm" style="padding-left: 35px;padding-right: 0px;">
                                    Sub Total (7/23) :
                                </label>
                                <div class="col-lg-2 col-sm-12" style="padding-left: 20px; padding-right: 0px;">
                                    <input id="nmb-subtotal_paket" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text">
                                </div>
                                <div class="col-lg-2 col-sm-12" style="padding-left: 10px;padding-right: 0px;">
                                    <input id="nmb-subtotal_npaket" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text">
                                </div>
                            </div>
                            <div class="form-group row">
                                <!-- <div class="col-lg-2" style="margin-top: 5px;">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4 col-sm-12 form-control-sm kt-font-sm" style="">
                                            PPN :
                                        </label>
                                        <div class="col-lg-3 col-sm-12" style="">
                                            <input id="nmb-persen" class="easyui-numberbox change" style="">
                                        </div>
                                        <label class="col-form-label col-lg-2 col-sm-12 form-control-sm kt-font-sm" style="">
                                            %
                                        </label>
                                        <div class="col-lg-3 col-sm-12" style="">
                                            <input id="nmb-ppn" class="form-control form-control-sm easyui-numberbox" style="" type="text" readonly="true">
                                        </div>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-lg-auto col-sm-12" style="padding-right: 7px;">
                                    <!-- <div class="form-group row"> -->
                                ...
                                <div class="col-lg-2 col-sm-12" style="padding-left: 0px;">
                                   <input id="nmb-ppn" class="col-lg-10 form-control form-control-sm easyui-numberbox" style="text-align: right;" type="text" readonly="true">
                                </div>
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm kt-font-sm" style="padding-left: 26px;padding-right: 0px;">
                                    PPN (7/23):
                                </label>
                                <div class="col-lg-2 col-sm-12" style="padding-left: -20px; padding-right: 0px;">
                                    <input id="nmb-ppn_paket" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text">
                                </div>
                                <div class="col-lg-2 col-sm-12" style="padding-left: 0px;padding-right: 0px;">
                                    <input id="nmb-ppn_npaket" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-1 col-sm-12 form-control-sm kt-font-sm" style="padding-right: 0px;">
                                ...
                                <div class="col-lg-2 col-sm-12" style="margin-left: 45px;">
                                    <input id="nmb-jrs" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text" readonly="true">
                                </div>
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm kt-font-sm" style="padding-left: 35px;padding-right: 0px;">
                                    J. Resep (7/23):
                                </label>
                                ...
                                <div class="col-lg-2 col-sm-12" style="padding-left: 10px;padding-right: 0px;">
                                    <input id="nmb-jrs_npaket" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm kt-font-sm kt-font-bold" style="padding-left: 35px;padding-right: 0px;">
                                    Total (7/23):
                                </label>
                                <div class="col-lg-2 col-sm-12" style="padding-left: 20px; padding-right: 0px;">
                                    <input id="nmb-total_paket" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text">
                                </div>
                                <div class="col-lg-2 col-sm-12" style="padding-left: 10px;padding-right: 0px;">
                                    <input id="nmb-total_npaket" class="col-lg-10 form-control form-control-sm easyui-numberbox change" style="text-align: right;" type="text">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="kt-portlet-win" style="margin-top: 0px;">
            <div class="kt-portlet__body header-form">
                <form class="kt-form col-lg-12 header-form" id="form-cari_nopp">
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-lg-12 table-detail">
                            <table id="dtg-e_resep" height="200" width="100%" class="easyui-datagrid" pagination="false" singleSelect="true" rownumbers="false" fitColumns="true">
                                <thead>
                                    <tr>
                    ...
                    <div class="row">
                        <div class="col-lg-12 table-detail">
                            <table id="dtg-e_resep_detail" height="230" width="100%" class="easyui-datagrid" pagination="false" singleSelect="true" rownumbers="true" fitColumns="true">
                                <thead>
                                    <tr>
                                        <th halign="center" align="center" field="nr" width="15%">NR</th>

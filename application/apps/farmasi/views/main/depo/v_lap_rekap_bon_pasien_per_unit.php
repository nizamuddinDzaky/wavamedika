...
<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Laporan Rekap Bon Per Unit</h3>
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="" class="kt-subheader__breadcrumbs-link">Laporan Rekap Bon Per Unit</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                ...
                <form class="kt-form col-lg-12 header-form kt-margin-t-25" id="form-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2 col-sm-12 form-control-sm">Kategori :</label>
                                <div class="col-lg-5 col-sm-12">
                                    <select class="select2 form-control change" id="cmb-kategori">
                                        <!--  -->
                                    </select>
                                </div>
                            </div>
            ...
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                ...
                <div class="table-custom" id="tbl1">
                    <table id="dtg1" height="500" width="100%" title="Daftar Laporan Rekap Bon Per Unit" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true" fitColumns="false">
                        <thead>
                            <tr>
                                <th halign="center" align="left" field="depo" width="20%">Depo</th>
                                <th halign="center" align="left" field="ruang" width="15%">Ruang</th>
                                <th halign="center" align="left" field="nama_kel_item" width="10%">Jenis</th>
                                <th halign="center" align="left" field="kd_item" width="10%">Kode</th>

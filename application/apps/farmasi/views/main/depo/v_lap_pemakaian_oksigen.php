...
<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Laporan Pemakaian Oksigen</h3>
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="" class="kt-subheader__breadcrumbs-link">Laporan Pemakaian Oksigen</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
            ...
            <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
                ...
                <div class="table-custom" id="tbl1">
                    <table id="dtg-pemakaian_oksigen" height="500" width="100%" title="Daftar Pemakaian Oksigen" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true" fitColumns="false">
                        <!--  -->
                    </table>
                </div>

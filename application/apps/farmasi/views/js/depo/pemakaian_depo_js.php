...
<script type="text/javascript">
    ...
    function get_select()
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/pemakaian_depo/get_data_unit_asal"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
        ...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/pemakaian_depo/get_data_unit_tujuan"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    function filter_barang_all()
    {
        ...
        var dg = $('#dtg-list_barang').datagrid({
          url : "<?php echo base_url("farmasi/depo/pemakaian_depo/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            // if (data.metadata.list_count<1)
    ...
    {
        $.ajax({
          url : "<?php echo base_url("farmasi/depo/pemakaian_depo/getPerKode"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: no_mutasi,
    ...
    function simpan()
    {
        ...
        $.ajax({
          url : "<?php echo base_url("farmasi/depo/pemakaian_depo/simpan"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function hapus(no_pp)
    {
        ...
        "customClass"      : {
          ...
          "cancelButton"     : "btn-secondary"
            ...
            if (result.value) {
                    $.ajax({
                      url : "<?php echo base_url("farmasi/depo/pemakaian_depo/hapus"); ?>",
                      type: "POST",
                      dataType: 'json',
                      data:{
                        data: data,
    ...
    function verifikasi(data,status)
    {
      ...
      $.ajax({
        url : "<?php echo base_url("farmasi/depo/pemakaian_depo/status"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: data,
    ...
    function cetak(){
      ...
      console.log(data_cetak);
        ...
        $.ajax({
            url     : "<?= base_url() ?>farmasi/depo/pemakaian_depo/cetak",
            type    : "POST",
          dataType: 'json', 
            data:data_cetak,
          success:function(data, textStatus, jqXHR){
            if (data.success === true) {
              ...
              var file_cetak = "Laporan_Pemakaian_Depo.pdf";

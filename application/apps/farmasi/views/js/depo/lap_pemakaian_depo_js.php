<script type="text/javascript">
	$(function(){
		...
		$.ajax({
	        url : "<?php echo base_url("farmasi/depo/lap_pemakaian_depo/get_unit_asal"); ?>",
	        type: "POST",
	        dataType: 'json',
	        beforeSend: function (){               
	        },
      	...
      	$.ajax({
	        url : "<?php echo base_url("farmasi/depo/lap_pemakaian_depo/get_unit_tujuan"); ?>",
	        type: "POST",
	        dataType: 'json',
	        beforeSend: function (){               
	        },
	...
	function filter() {
		...
		var dg = $('#dtg1').datagrid({
			url : "<?php echo base_url("farmasi/depo/Lap_pemakaian_depo/filter"); ?>",
			method: "POST",
			queryParams: data,
	...
	function set_form()
	{
		...
		var url_control = "<?= base_url() ?>farmasi/depo/Lap_pemakaian_depo/cetak";
		...
		$('#name_unit_asal').val(name_unit_asal);
		$('#name_unit_tujuan').val(name_unit_tujuan);
		/*$('#id_unit').val(id_unit);*/
	...
	function cetak() {
		...
		$.ajax({
	        url     : "<?= base_url() ?>farmasi/depo/Lap_pemakaian_depo/cetak",
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,
	     	success:function(data, textStatus, jqXHR){
	        if (data.success === true) {
	          $('#loader').css('display','none');
	            var file_cetak ='Laporan Pemakaian Depo.pdf';
	...
	function export_excel()
	{
		...
		$.ajax({
	        url     : "<?= base_url() ?>farmasi/depo/Lap_pemakaian_depo/check_data",
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,
	     	success:function(data, textStatus, jqXHR){

<script type="text/javascript">
    ...
    $('#dtg-nota_rawat_jalan').datagrid({
        ...
        columns:[[
            ...
            {field:'c_status_posting',title:'Status Posting',width:"5%",halign:'center',align:'left'},
            {field:'c_status_proses',title:'Status Proses',width:"5%",halign:'center',align:'left'},
            ...
            formatter:function(value,row){
              ...
              editor:{
                ...
                options:{
                    ...
                    data      : data_item_rc,
                    // url       :'<?php echo base_url('farmasi/depo/Bon_pemakaian_pasien/get_signa/1') ?>',
                    required  :true
                }
              }
            },//
            ...
            formatter:function(value,row){
              ...
              editor:{
                ...
                options:{
                    ...
                    valueField:'signa',
                    textField :'signa',
                    url       :'<?php echo base_url('farmasi/depo/Bon_pemakaian_pasien/get_signa/2') ?>',
                    required  :true
                }
              }
            },//
    ...
    {
        $.ajax({
            url     : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/getPerNota"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data:no,
    ...
    function get_konfigurasi()
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/get_konfigurasi"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    function get_select(argument)
    {
        ...
        if (argument=='ruang')
        {
            url_con =  "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/get_kamar"); ?>";
            id_cmb  = "#cmb-klinik_ruang";
            param   = 1;
        }
        else if(argument=='dokter')
        {
            url_con =  "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/get_dokter"); ?>";
            id_cmb  = "#cmb-dokter";
        }
        // body...
        $.ajax({
    ...
    function filter()
    {
        ...
        var dg = $('#dtg-nota_rawat_jalan').datagrid({
          url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function cari_billing(argument)
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/filter_no_billing/1"); ?>",
            type: "POST",
            dataType: 'json',
            data    :{
                data:argument,
    ...
    function filter_billing()
    {
        ...
        var dg = $('#dtg-billing').datagrid({
          url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/filter_no_billing/0"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function cek_resep(kondisi,no)
    {
        ...
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/"); ?>"+url_con,
            type: "POST",
            dataType: 'json',
            data    :{
                data:no,
    ...
    function filter_paket(argument,row)
    {
        ...
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/filter_paket_item"); ?>",
            type: "POST",
            dataType: 'json',
            data    : param,
            beforeSend: function (){               
    ...
    function simpan()
    {
        ...
        $.ajax({
          url : "<?php echo base_url('farmasi/depo/Bon_pemakaian_pasien/simpan'); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            config : config,
    ...
    function hapus()
    {
        ...
        swal.fire(cohapus()).then(function(result) {
          if (result.value) {
            $.ajax({
                url     : "<?php echo base_url("/farmasi/depo/Bon_pemakaian_pasien/hapus"); ?>",
                type    : "POST",
                dataType: 'json',
                data    :{
                    data: no_nota,
    ...
    function filter_unit()
    {
        ...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/get_unit_default"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    function pilih_unit()
    {
        ...
        $.ajax({
            url     : "<?php echo base_url("/farmasi/depo/Bon_pemakaian_pasien/ganti_unit"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                id  : row.id_unit,
    ...
    function get_data_item(param)
    {
        ...
        $('.tr-list').remove();
        ajaxReq = $.ajax({
          url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/cari_item"); ?>",
          type: "GET",
          dataType: 'json',
          data:{
            type: 'public',
    ...
    function ambil_sebagian(argument)
    {
        ...
        if (ket_detail['ket']==1)
        {
            ...
            {
                data_sebagian.push(data_detail[i]['jml']);
            }
        }
        else
        {
    ...
    function proses_bagi(data,argument)
    {
        ...
        for(i=0 ; i < data.length ; i++)
        {
            ...
            {
                sebagian_jml =  data[i]/2;
                ket_detail['ket'] = 2;
            }
            else if (argument==13)
            {
                sebagian_jml = data[i]/3;
                ket_detail['ket'] = 3;
            }
            else if (argument==14)
            {
                sebagian_jml = data[i]/4;
                ket_detail['ket'] = 4;
            }

            // console.log("sebagian_jml = "+sebagian_jml);
            // console.log("sebagian_jml ceil = "+Math.ceil(sebagian_jml));
            ...
            $('#dtg-detail_item').datagrid('updateRow', {
              index: i,
              row: {jml: sebagian_jml,jml_paket : 0,jml_npaket : 0}
            });
    ...
    function cari_item_datagrid(kriteria)
    {
        ...
        $.ajax({
            url : "<?php echo base_url("farmasi/depo/Bon_pemakaian_pasien/cari_item_datagrid"); ?>",
            type: "GET",
            dataType: 'json',
            data:{
            type: 'public',

<script type="text/javascript">
	...
	function filter() {
		$('#dtg-fast_moving').datagrid('loadData',[]);
		...
		var dg = $('#dtg-fast_moving').datagrid({
			url : "<?php echo base_url("farmasi/gudang/Lap_fast_moving/filter"); ?>",
			method: "POST",
			queryParams: data,
	...
	function set_form()
	{
		...
		var url_control = "<?= base_url() ?>farmasi/gudang/Lap_fast_moving/cetak";
	...
	function export_excel()
	{
		...
		$.ajax({
	        url     : "<?= base_url() ?>farmasi/gudang/Lap_fast_moving/check_data",
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,

...
<script type="text/javascript">
    ...
    $(function () {
      ...
      $.ajax({
        url : "<?php echo base_url("farmasi/gudang/Permintaan_bmhp/get_unit_asal"); ?>",
        type: "POST",
        dataType: 'json',
        beforeSend: function (){               
        },
      ...
      $.ajax({
        url : "<?php echo base_url("farmasi/gudang/Permintaan_bmhp/get_unit_tujuan"); ?>",
        type: "POST",
        dataType: 'json',
        beforeSend: function (){               
        },
        ...
        $('#btn-tampil').click(function () {
            var row = $('#dtg-permintaan_bmhp').datagrid('getSelected');
            if(row <= 0)
            {
    ...
    function filter()
    {
        $('#dtg-permintaan_bmhp').datagrid('loadData',[]);
        ...
        var dg = $('#dtg-permintaan_bmhp').datagrid({
          url : "<?php echo base_url("farmasi/gudang/permintaan_bmhp/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_barang()
    {
        ...
        var dg = $('#dtg-cari_barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/Permintaan_bmhp/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            console.log(data);
    ...
    function hapus(row)
    {
        ...
        swal.fire(cohapus()).then(function(result) {
              if (result.value) {
                  $.ajax({
                    url : "<?php echo base_url("farmasi/gudang/permintaan_bmhp/hapus"); ?>",
                    type: "POST",
                    dataType: 'json',
                    data:{
                      data: data,
    ...
    function default_auth()
    {
        ...
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/Permintaan_bmhp/default_auth"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function status(status,no)
    {
        ...
        // $.ajax({
        //   url : "<?php echo base_url("farmasi/gudang/permintaan_bmhp/status"); ?>",
        //   type: "POST",
        //   dataType: 'json',
        //   data:{
        //     data: data,
    ...
    function simpan() {
      ...
      $.ajax({
        url : "<?php echo base_url("farmasi/gudang/Permintaan_bmhp/simpan"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data:data,
    ...
    function getData(row)
    {
      ...
      $.ajax({
        url : "<?php echo base_url("farmasi/gudang/permintaan_bmhp/getPerKode"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: row.no_pm,
    ...
    function cetak(){
      ...
      // console.log(data_cetak);
        ...
        $.ajax({
            url     : "<?= base_url() ?>farmasi/gudang/permintaan_bmhp/cetak",
            type    : "POST",
          dataType: 'json', 
            data:data_cetak,
          success:function(data, textStatus, jqXHR){
            if (data.success === true) {
              ...
              var file_cetak = "Laporan_Permintaan_BMHP.pdf";

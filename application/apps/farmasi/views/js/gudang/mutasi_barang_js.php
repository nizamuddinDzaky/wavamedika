...
<script type="text/javascript">
    ...
    function filter()
    {
        ...
        // $.ajax({
        //   url : "<?php echo base_url("farmasi/gudang/mutasi_barang/filter"); ?>",
        //   type: "POST",
        //   dataType: 'json',
        //   data:{
        //     data: data,
    ...
    function filter_barang()
    {
        ...
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/mutasi_barang/Filter_barang_no_mutasi"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function filter_barang_all()
    {
        ...
        var dg = $('#dtg-list_barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/mutasi_barang/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            // if (data.metadata.list_count<1)
    ...
    {
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/mutasi_barang/getPerKode"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: no_mutasi,
    ...
    function simpan()
    {
        ...
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/mutasi_barang/simpan"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function hapus(no_pp)
    {
        ...
        "customClass"      : {
          ...
          "cancelButton"     : "btn-secondary"
            ...
            if (result.value) {
                    $.ajax({
                      url : "<?php echo base_url("farmasi/gudang/mutasi_barang/hapus"); ?>",
                      type: "POST",
                      dataType: 'json',
                      data:{
                        data: data,
    ...
    function default_auth()
    {
        ...
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/mutasi_barang/default_auth"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function verifikasi(data,status)
    {
      ...
      $.ajax({
        url : "<?php echo base_url("farmasi/gudang/mutasi_barang/status"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: data,

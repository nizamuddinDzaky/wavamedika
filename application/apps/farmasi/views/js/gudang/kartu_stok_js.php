<script type="text/javascript">
            ...
            {      
              ...
              // console.log(rowData.id_item);
                ...
                var dg = $('#dtg-detail').datagrid({
                    url : "<?php echo base_url("farmasi/gudang/kartu_stok/filter_detail"); ?>",
                    method: "POST",
                    queryParams: detail,
               ...
               var dg = $('#dtg-detail_stok').datagrid({
                    url : "<?php echo base_url("farmasi/gudang/kartu_stok/filter_detail_stok"); ?>",
                    method: "POST",
                    queryParams: detail,
                    loadFilter: function(data) {
                // if (data.metadata.list_count<1)
    ...
    $('#dtg-detail').datagrid({
        ...
        columns:[[
            ...
            {field:'masuk',title:'Masuk',width:"8%",halign:'center',align:'right',formatter: appGridNumberFormatter},
            {field:'keluar',title:'Keluar',width:"8%",halign:'center',align:'right',formatter: appGridNumberFormatter},
        ]],
    });

    $('#dtg-detail_stok').datagrid({
        singleSelect:true,
        idField:'itemid',
        onDblClickRow:function(index,row){
            //
        ...
        columns:[[
            {field:'nama_unit',title:'Unit',width:"20%",halign:'center',align:'left'},
            {field:'stok_awal',title:'Stok Awal',width:"9%",halign:'center',align:'right',formatter: appGridNumberFormatter},
            {field:'masuk',title:'Masuk',width:"8%",halign:'center',align:'right',formatter: appGridNumberFormatter},
            {field:'akhir',title:'Keluar',width:"8%",halign:'center',align:'right',formatter: appGridNumberFormatter},
            {field:'stok_akhir',title:'Stok Akhir',width:"9%",halign:'center',align:'right',formatter: appGridNumberFormatter},
        ]],
    });
    ...
    function filter()
    {
        ...
        var dg = $('#dtg-kartu_stok').datagrid({
          url : "<?php echo base_url("farmasi/gudang/kartu_stok/filter"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            // if (data.metadata.list_count<1)
    ...
    function get_select()
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/gudang/kartu_stok/get_data_unit"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    function cetak(){
        $('#loader').css('display','');
            ...
            var criteria   = $('#txt-criteria').val();
            var id_unit    = $('#cmb-unit option:selected').val();
            var file_cetak = 'Kartu Stok Tanggal '+convertDateDBtoIndo(start_date)+' sd '+convertDateDBtoIndo(end_date)+'.pdf';
            ...
            $.ajax({
                ...
                url     : "<?= base_url() ?>farmasi/gudang/kartu_stok/print_transaksi1",
                type    : "POST",
                dataType: 'json',   
                data    : data,
          //     data:{
    ...
    function cetak_detail(){
        $('#loader').css('display','');
            ...
            $.ajax({
                ...
                url     : "<?= base_url() ?>farmasi/gudang/kartu_stok/print_detail",
                type    : "POST",
                dataType: 'json',   
                data    : data,
          //     data:{
    ...
    function cetak_stok(){
        $('#loader').css('display','');
            ...
            var end_date   = toAPIDateFormat($('#dtb-end_date').val());
            var id_unit    = $('#cmb-unit option:selected').val();
            var file_cetak = 'Detail Transaksi Kartu Stok Per Item Tanggal   '+convertDateDBtoIndo(start_date)+' sd '+convertDateDBtoIndo(end_date)+'.pdf';
            ...
            $.ajax({
                ...
                url     : "<?= base_url() ?>farmasi/gudang/kartu_stok/print_stok",
                type    : "POST",
                dataType: 'json',   
                data    : data,
          //     data:{
  ...
  $('body').on('click', '#btn-export', function () {
        ...
        var url_control = "<?= base_url() ?>farmasi/gudang/kartu_stok/print_transaksi1";

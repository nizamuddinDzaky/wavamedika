...
//this doesn't work
    ...
    {
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/getPerKode"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: no_bpb,
    ...
    function get_select()
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/get_data_gudang"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    function filter()
    {
        ...
        var dg = $('#dtg-penerimaan_barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_supplier()
    {
        ...
        var dg = $('#dtg-data_supplier').datagrid({
          url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/filter_supplier"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
    ...
    function filter_nopo()
    {
        ...
        var dg = $('#dtg-list_barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/filter_nopo"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            // if (data.metadata.list_count<1)
    ...
    $('#dtg-penerimaan_barang').datagrid({
        ...
        columns:[[
            ...
            {field:'jns_po',title:'Jenis PO',width:"10%",halign:'center',align:'left'},
    ...
    function filter_barang()
    {
        ...
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/Filter_barang_po"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function simpan()
    {
        ...
        $.ajax({
          url : "<?php echo base_url('farmasi/gudang/penerimaan_barang/simpan'); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            data: data,
    ...
    function verifikasi(data,status)
    {
      ...
      $.ajax({
        url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/status"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: data,
    ...
    function hapus() {
      ...
      swal.fire(cohapus()).then(function(result) {
          if (result.value) {
              $.ajax({
                url : "<?php echo base_url("farmasi/gudang/penerimaan_barang/hapus"); ?>",
                type: "POST",
                dataType: 'json',
                data:{
                  data: data,
    ...
    function cetak(){
        ...
        $.ajax({
            url     : "<?= base_url() ?>farmasi/gudang/Penerimaan_barang/cetak",
            type    : "POST",
            dataType: 'json', 
            data    : data_cetak,
            success:function(data, textStatus, jqXHR){
            if (data.success === true) {
                ...
                let file_cetak = "Laporan_Penerimaan_Barang.pdf";

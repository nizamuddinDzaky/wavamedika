...
//this doesn't work
        ...
        $.ajax({
            url : "<?php echo base_url("farmasi/gudang/Order_pembelian/termin_bayar"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
        ...
        $.ajax({
            url : "<?php echo base_url("farmasi/gudang/Order_pembelian/termin_kirim"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
   ...
   /* $('#src-nopp').searchbox({
    ...
    function filter_no_pp() {
        ...
        var dg = $('#dtg-list_barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/Order_pembelian/filter_no_pp"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_supplier() {
        ...
        var dg = $('#dtg-data_supplier').datagrid({
          url : "<?php echo base_url("farmasi/gudang/Order_pembelian/filter_supplier"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function filter_barang() {
        ...
        var dg = $('#dtg-filter_barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/Order_pembelian/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function default_auth()
    {
        ...
        var dg = $('#dtg-auth').datagrid({
          url : "<?php echo base_url("farmasi/gudang/Order_pembelian/default_auth"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function simpan() {
        ...
        $.ajax({
          url : "<?php echo base_url("farmasi/gudang/Order_pembelian/simpan"); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            master: master,
    ...
    function filter() {
        ...
        var dg = $('#dtg-order_pembelian').datagrid({
          url : "<?php echo base_url("farmasi/gudang/Order_pembelian/filter"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    {
      $.ajax({
        url : "<?php echo base_url("farmasi/gudang/Order_pembelian/getPerKode"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: no_po,
    ...
    function hapus() {
      ...
      swal.fire(cohapus()).then(function(result) {
          if (result.value) {
              $.ajax({
                url : "<?php echo base_url("farmasi/gudang/Order_pembelian/hapus"); ?>",
                type: "POST",
                dataType: 'json',
                data:{
                  data: data,
    ...
    function verifikasi(data,status) {
        ...
        $.ajax({
            url : "<?php echo base_url("farmasi/gudang/Order_pembelian/status"); ?>",
            type: "POST",
            dataType: 'json',
            data:{
                data: data,
    ...
    function cetak(){
        ...
        $.ajax({
            url     : "<?= base_url() ?>farmasi/gudang/Order_pembelian/cetak",
            type    : "POST",
            dataType: 'json', 
            data    : data_cetak,
            success:function(data, textStatus, jqXHR){
            if (data.success === true) {
                ...
                let file_cetak = "Laporan_Order_Pembelian_Farmasi.pdf";

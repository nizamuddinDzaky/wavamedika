<script type="text/javascript">
    ...
    function btn_ubah()
    {
        var row = $('#dtg-pembelian_general').datagrid('getSelected');
        if(row <= 0)
        {
	...
	$('#dtg-pembelian_general').datagrid({
		singleSelect:true,
		idField:'itemid',
    ...
    function get_gudang()
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/gudang/pembelian_general/get_gudang"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    function filter()
    {
        $('#dtg-pembelian_general').datagrid('loadData', []);
        ...
        var dg = $('#dtg-pembelian_general').datagrid({
            url : "<?php echo base_url("farmasi/gudang/pembelian_general/filter"); ?>",
            method: "POST",
            queryParams: data,
    ...
    function filter_supplier()
    {
        ...
        var dg = $('#dtg-supplier').datagrid({
          url : "<?php echo base_url("farmasi/gudang/pembelian_general/filter_supplier"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function filter_kasbon()
    {
        ...
        var dg = $('#dtg-kasbon').datagrid({
          url : "<?php echo base_url("farmasi/gudang/pembelian_general/filter_uang_muka"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function filter_barang()
    {
        ...
        var dg = $('#dtg-barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/pembelian_general/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function simpan()
    {
        ...
        $.ajax({
          url : "<?php echo base_url('farmasi/gudang/pembelian_general/simpan'); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            master:master,
    ...
    {
        $.ajax({
            url     : "<?php echo base_url("farmasi/gudang/pembelian_general/getPembelian"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data:no,
    ...
    function verifikasi(data,status) {
        ...
        $.ajax({
            url     : "<?php echo base_url("/farmasi/gudang/pembelian_general/verifikasi"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data: data,
    ...
    function hapus(){
        ...
        swal.fire(cohapus()).then(function(result) {
          if (result.value) {
            $.ajax({
                url     : "<?php echo base_url("/farmasi/gudang/pembelian_general/hapus"); ?>",
                type    : "POST",
                dataType: 'json',
                data    :{
                    data: data,

<script type="text/javascript">
	...
	function filter()
	{
	  ...
	  var dg = $(tabel_utama).datagrid({
	    url : "<?php echo base_url("farmasi/gudang/lap_pembelian_farmasi/filter"); ?>",
	    method: "POST",
	    queryParams: data,
...
function cetak(){
  ...
  // alert(tipe);
	...
	// alert(file_cetak);
	    ...
	    $.ajax({
			...
			url     : "<?= base_url() ?>farmasi/gudang/lap_pembelian_farmasi/"+cetak,
			type    : "POST",
			dataType: 'json',	
			data    : data,
	  //     data:{
 ...
 //  	 	var cetak;
	...
	// 	var url_control = "<?= base_url() ?>farmasi/gudang/lap_pembelian_farmasi/"+cetak;

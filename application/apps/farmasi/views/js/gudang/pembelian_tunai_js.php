<script type="text/javascript">
    ...
    function get_gudang()
    {
        // body...
        $.ajax({
            url : "<?php echo base_url("farmasi/gudang/pembelian_tunai/get_gudang"); ?>",
            type: "POST",
            dataType: 'json',
            beforeSend: function (){               
            },
    ...
    function filter()
    {
        ...
        var dg = $('#dtg-pembelian_tunai').datagrid({
          url : "<?php echo base_url("farmasi/gudang/pembelian_tunai/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_supplier()
    {
        ...
        var dg = $('#dtg-supplier').datagrid({
          url : "<?php echo base_url("farmasi/gudang/pembelian_tunai/filter_supplier"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function filter_kasbon()
    {
        ...
        var dg = $('#dtg-kasbon').datagrid({
          url : "<?php echo base_url("farmasi/gudang/pembelian_tunai/filter_uang_muka"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function filter_barang()
    {
        ...
        var dg = $('#dtg-barang').datagrid({
          url : "<?php echo base_url("farmasi/gudang/pembelian_tunai/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function simpan()
    {
        ...
        $.ajax({
          url : "<?php echo base_url('farmasi/gudang/pembelian_tunai/simpan'); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            master:master,
    ...
    {
        $.ajax({
            url     : "<?php echo base_url("farmasi/gudang/pembelian_tunai/getPembelian"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data:no,
    ...
    function verifikasi(data,status) {
        ...
        $.ajax({
            url     : "<?php echo base_url("/farmasi/gudang/pembelian_tunai/verifikasi"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data: data,
    ...
    function hapus(){
        ...
        swal.fire(cohapus()).then(function(result) {
          if (result.value) {
            $.ajax({
                url     : "<?php echo base_url("/farmasi/gudang/pembelian_tunai/hapus"); ?>",
                type    : "POST",
                dataType: 'json',
                data    :{
                    data: data,
    ...
    function cetak(){
        ...
        $.ajax({
            url     : "<?= base_url() ?>farmasi/gudang/Pembelian_tunai/cetak",
            type    : "POST",
            dataType: 'json', 
            data    : data_cetak,
            success:function(data, textStatus, jqXHR){
            if (data.success === true) {
                ...
                let file_cetak = "Laporan_Pembelian_Tunai.pdf";

<script type="text/javascript">
	...
	function filter() {
		...
		var dg = $(tabel_utama).datagrid({
			url : "<?php echo base_url("farmasi/gudang/Lap_koreksi_stok/filter"); ?>",
			method: "POST",
			queryParams: data,
	...
	function cetak() {
		...
		$.ajax({
	        url     : "<?= base_url() ?>farmasi/gudang/Lap_koreksi_stok/cetak_"+url,
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,
    ...
    {
      $.ajax({
          url : "<?php echo base_url("farmasi/gudang/Lap_koreksi_stok/get_data_unit"); ?>",
          type: "POST",
          dataType: 'json',
          beforeSend: function (){               
          },
    ...
    function set_form()
	{
		...
		var url_control = "<?= base_url() ?>farmasi/gudang/Lap_koreksi_stok/cetak_"+url;
	...
	function export_excel()
	{
		...
		$.ajax({
	        url     : "<?= base_url() ?>farmasi/gudang/Lap_koreksi_stok/check_data",
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,
	     	success:function(data, textStatus, jqXHR){

...
function get_select()
{
    // body...
    $.ajax({
        url : "<?php echo base_url("farmasi/gudang/Permintaan_mutasi/get_unit_asal"); ?>",
        type: "POST",
        dataType: 'json',
        beforeSend: function (){               
        },
    ...
    $.ajax({
        url : "<?php echo base_url("farmasi/gudang/Permintaan_mutasi/get_unit_tujuan"); ?>",
        type: "POST",
        dataType: 'json',
        beforeSend: function (){               
        },
...
function loadAuth() {
    ...
    $.ajax({
        url     : "<?php echo base_url("/farmasi/gudang/Permintaan_mutasi/getAuth"); ?>",
        type    : "POST",
        dataType: 'json',
        data    :{
            data:data
...
function verifikasi(data,status) {
    ...
    $.ajax({
        url     : "<?php echo base_url("/farmasi/gudang/Permintaan_mutasi/verifikasi"); ?>",
        type    : "POST",
        dataType: 'json',
        data    :{
            data: data,
...
function hapus(no_permintaan){
    ...
    swal.fire(cohapus()).then(function(result) {
      if (result.value) {
        $.ajax({
            url     : "<?php echo base_url("/farmasi/gudang/Permintaan_mutasi/hapus"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data: data,
...
function filter() {
    ...
    // $.ajax({
    //     url     : "<?php echo base_url("/farmasi/gudang/Permintaan_mutasi/filter"); ?>",
    //     type    : "POST",
    //     dataType: 'json',
    //     data    :
    //     {
...
function filter_data_item() {
    ...
    // $.ajax({
    //     url : "<?php echo base_url("/farmasi/gudang/Permintaan_mutasi/search_item"); ?>",
    //     type: "POST",
    //     dataType: 'json',
    //     data:{
    //       data: data,
...
function simpan() {
    ...
    $.ajax({
        url : "<?php echo base_url("/farmasi/gudang/Permintaan_mutasi/simpan"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
            master:data,
...
function get_data(no_pm){
    $.ajax({
        url     : "<?php echo base_url("/farmasi/gudang/Permintaan_mutasi/getPermintaan"); ?>",
        type    : "POST",
        dataType: 'json',
        data    :{
            data:no_pm,

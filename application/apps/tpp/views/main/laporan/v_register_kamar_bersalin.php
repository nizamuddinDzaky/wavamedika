      ...
      <table id="tabel_rekap" height="500" title="Rekapitulasi" class="easyui-datagrid" rownumbers="true" singleSelect="true">
       <thead>
        <tr>
         ...
         <th data-options="field:'s'" width="10%">S</th>
         <th data-options="field:'r'" width="10%">R</th>
      ...
      <table id="tabel_detail" height="500" title="<?= $title ?>" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true" pageSize="10">
       <thead>
        <tr>
         ...
         <th width="100" align="left" halign="center" data-options="field: 'kunjungan_unit'">Kunj. Unit</th>
         <th width="100" align="left" halign="center" data-options="field: 'ruang'">Ruang</th>
         <th width="200" align="left" halign="center" data-options="field: 'dokter'">Dokter</th>
         <th width="150" align="left" halign="center" data-options="field: 'tindak_lanjut'">Tindak Lanjut</th>
         <th width="150" align="left" halign="center" data-options="field: 'keadaan_keluar'">Keadaan Keluar</th>
         <th width="200" align="left" halign="center" data-options="field: 'nama_perujuk'">Nama Perujuk</th>
        </tr>
       </thead>
       <tfoot>
        <tr></tr>

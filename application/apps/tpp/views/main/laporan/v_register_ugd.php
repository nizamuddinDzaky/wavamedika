      ...
      <table id="tabel_rekap" height="500" title="Rekapitulasi" class="easyui-datagrid" rownumbers="true" singleSelect="true">
       <thead>
        <tr>
         ...
         <th data-options="field:'nb'" width="10%">NB</th>
         <th data-options="field:'a'" width="10%">A</th>
         <th data-options="field:'obg'" width="10%">OBG</th>
        </tr>
       </thead>
       <tfoot>
        <tr></tr>
      ...
      <table id="tabel_detail" height="500" title="<?= $title ?>" class="easyui-datagrid" pagination="true" rownumbers="true" singleSelect="true" pageSize="10">
       <thead>
        <tr>
         ...
         <th width="200" data-options="field: 'nama_lengkap'">Nama Pasien</th>
         ...
         <th width="40" align="left" halign="center" data-options="field: 'sex'">Sex</th>
         <th width="75" align="left" halign="center" data-options="field: 'umur'">Umur</th>
         <th width="100" align="left" halign="center" data-options="field: 'alamat'">Alamat</th>
         <th width="100" align="left" halign="center" data-options="field: 'cara_masuk'">Cara Masuk</th>
         <th width="70" align="left" halign="center" data-options="field: 'kunjungan'">Kunj. MRS</th>
         <th width="70" align="left" halign="center" data-options="field: 'kunjungan_unit'">Kunj. Unit</th>
         <th width="200" align="left" halign="center" data-options="field: 'dokter'">Dokter</th>
         <th width="100" align="left" halign="center" data-options="field: 'keadaan_keluar'">Keadaan Keluar</th>
         <th width="100" align="left" halign="center" data-options="field: 'tindak_lanjut'">Tindak Lanjut</th>

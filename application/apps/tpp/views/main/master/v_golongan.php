   ...
   <div class="kt-portlet__body kt-portlet__body--fit kt-margin-b-20">
    <div class="table-custom">
     <table title="Data <?= $title ?>"
      ...
      <thead>
       <tr>
         <!--<th data-options="field:'id_golonganpx',width:50,align:'center'">ID</th>-->
        <th data-options="field:'golongan_px',width:200,editor:'textbox'">Golongan Pasien</th>
       </tr>
      </thead>
     </table>
     ...
     <div id="tambahData"
          ...
          data-title="Tambah Golongan Pasien"
          class="panel-window"
          style="width:640px">
        ...
        <form class="kt-form col-lg-12 header-form" id="formTambah">
         ...
         <div class="form-group row">
          ...
          <div class="col-lg-4 col-sm-12">
           <button type="button" onclick="javascript:$('#tambahData').window('close').find(':input').val('').trigger('change')" class="btnBatal form-control form-control-sm btn btn-sm btn-secondary">
     ...
     <div id="editData" data-title="Edit Golongan Pasien"
          class="panel-window" style="width:640px;">
      <div class="kt-portlet">
       <div class="kt-portlet__body_win header-form">
        <form class="kt-form col-lg-12 header-form" id="formEdit">
         <input type="hidden" id="id_golonganpx" name="id_golonganpx">
         <div class="form-group row">
          <label class="col-form-label col-lg-3 col-sm-12 form-control-sm kt-font-sm">
           Golongan :
          </label>
          <div class="col-lg-8 col-sm-12">
           <input id="golongan_px" name="golongan_px" class="form-control form-control-sm" type="text">
          </div>
         </div>
         <hr>
         <div class="form-group row">

        ...
        <div class="row">
          ...
          <div class="col-lg-12 kt-padding-t-10-mobile" style="border-bottom: 2px solid #D3D3D3;margin-bottom: 10px;">
            <div class="form-group row">
              ...
              <div class="col-lg-2 col-md-12 div_simpan after-loading">
                <button id="btn-simpan" type="button" class="form-control form-control-sm btn btn-sm btn-primary" onclick="SimpanEditPasien()">
          ...
          <div class="col-md-12 col-sm-12 header-form kt-margin-t-10">
            ...
            <form class="row" id="edit-pasien">
              <input type="hidden" class="id_mr" name="id_mr" value="<?= $id ?>">
          ...
          <div class="col-lg-12 kt-padding-t-10-mobile" style="border-top: 2px solid #D3D3D3;padding-top: 10px;">
            <div class="form-group row ">
              <div class="col-lg-2 col-md-12 div_simpan">
                <button id="btn-simpan" type="button" class="form-control form-control-sm btn btn-sm btn-primary after-loading" onclick="SimpanEditPasien()">
                  <i class="fas fa-save"></i>
                  Simpan
                </button>
              </div>

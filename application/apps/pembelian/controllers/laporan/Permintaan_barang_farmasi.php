...
class Permintaan_barang_farmasi extends CI_Controller {
	...
	function index()
	{
		$this->data['js'] = 'laporan/permintaan_barang_farmasi_js';
        $this->data['main_view'] = 'laporan/v_permintaan_barang_farmasi';
	...
	function filter()
    {
        ...
        if($param['id_jns']==3){
            $path = "laporan/pembelian/farmasi/";
        	$lap="minta_mutasi";
            ...
            $i=0;
                $html.='<table class="atas" cellspacing="0" style="width: 100%;border:1px black solid;">
                    <tr style="border:1px black solid;">
                        ...
                        <th align="center" width="5%"><b>Sisa</b></th>
                        <th align="center" width="5%"><b>Sisa (%)</b></th>
                    </tr>';
                    $no=1;
                    foreach ($result['data'] as $key) {

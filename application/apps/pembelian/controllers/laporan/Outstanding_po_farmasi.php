...
class Outstanding_po_farmasi extends CI_Controller {
	...
	{
		$this->data['js'] = 'laporan/outstanding_po_farmasi_js';
        $this->data['main_view'] = 'laporan/v_outstanding_po_farmasi';
    ...
    public function filter()
    {
        ...
        $url = BASE_URL_FARMASI.'laporan/pembelian/farmasi/po/outstanding';
        // echo $url;die;
...
/* End of file Outstanding_po.php */
/* Location: ./application/apps/pembelian/controllers/laporan/Outstanding_po.php */
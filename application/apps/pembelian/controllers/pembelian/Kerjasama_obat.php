...
class Kerjasama_obat extends CI_Controller {
	...
	{
        $this->data['js'] = 'pembelian/kerjasama_obat_js';
        $this->data['main_view'] = 'pembelian/v_kerjasama_obat';
	...
	public function filter()
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'pembelian/farmasi/kerjasama/obat/search');
    ...
    public function filter_barang()
    {
        ...
        $headers  = getHeaderToken();
        $curl_handle = curl_init();
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'pembelian/farmasi/kerjasama/obat/list_item');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);
        curl_setopt($curl_handle, CURLOPT_POSTFIELDS,json_encode($data));
    ...
    {
        $API = BASE_URL_API_LPS."pembelian/farmasi/kerjasama/obat/get/".$_POST['data'];
    ...
    public function simpan()
    {
        ...
        if (isset($_POST['master']['no_kerjasama_item'])) {
            $url = BASE_URL_API_LPS.'pembelian/farmasi/kerjasama/obat/update';
        }else{
            $url = BASE_URL_API_LPS.'pembelian/farmasi/kerjasama/obat/insert';
        }
    ...
    public function hapus()
    {
        ...
        curl_setopt($curl_handle, CURLOPT_URL, BASE_URL_API_LPS.'pembelian/farmasi/kerjasama/obat/delete');
        curl_setopt($curl_handle, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($curl_handle, CURLOPT_POST, 1);
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, $headers);
    ...
    public function cetak()
    {
        ...
        if ($param['type_file']==2)
        {
            ...
            header("Content-Disposition: attachment; filename=Laporan_kerjasama_pembelian_obat.xls");
        ...
        <div align="center"><b><u>LAPORAN KERJASAMA PEMBELIAN OBAT PRODUSEN'; 
        $html.='</u></b><br>';
        if($tipe==1){
        ...
        else
        {
            ...
            $pdf->Output("assets/laporan/"."Laporan Kerjasama Pembelian Obat ".$no_kerjasama_item.".pdf", "F");
            $return["success"] = TRUE;
...
/* End of file Kerjasama_obat.php */
/* Location: ./application/apps/pembelian/controllers/pembelian/Kerjasama_obat.php */
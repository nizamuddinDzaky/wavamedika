<script type="text/javascript">
	...
	function filter_supplier(){
        ...
        var dg = $('#dtg-supplier').datagrid({
			url        : "<?php echo base_url("pembelian/laporan/outstanding_po_farmasi/filter_supplier"); ?>",
			method     : "POST",
			queryParams: data,
	...
	function filter() {
		...
		var dg = $('#dg-outstanding-po-farmasi').datagrid({
			url : "<?php echo base_url("pembelian/laporan/Outstanding_po_farmasi/filter"); ?>",
			method: "POST",
			queryParams: data,
			loadFilter: function(data) {
			  return {
	...
	function set_form()
	{
		...
		var url_control = "<?= base_url() ?>pembelian/laporan/Outstanding_po_farmasi/cetak";
		...
		$('#file_name').val('Outstanding_po_farmasi');
	...
	function export_excel()
	{
		...
		$.ajax({
	        url     : "<?= base_url() ?>pembelian/laporan/Outstanding_po_farmasi/check_data",
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,
	...
	function cetak(){
		...
		data={
			...
			page_row    : 10,
			type_file	: 1,
			file_name 	: 'Outstanding_po_farmasi.pdf'
		}

        $.ajax({
            url     :  "<?php echo base_url("pembelian/laporan/Outstanding_po_farmasi/cetak"); ?>",
            type    : "POST",
            dataType: 'json',   
            data    : data,
          	success:function(data, textStatus, jqXHR){

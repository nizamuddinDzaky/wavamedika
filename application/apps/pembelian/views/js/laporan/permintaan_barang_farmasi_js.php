<script type="text/javascript">
	        ...
	        onExpandRow: function(index,row){
	            ...
	            ddv.datagrid({
	                ...
	                columns:[[
			            ...
			            {field:'jml_muta',title:'Jml. Stok',width:"12%",halign:'center',align:'right',formatter: appGridNumberFormatter},
			            {field:'jml_mut',title:'Jml. Permintaan',width:"13%",halign:'center',align:'right',formatter: appGridNumberFormatter},
			            {field:'jml_stok',title:'Tgl. Kebutuhan',width:"10%",halign:'center',align:'right',formatter: appGridDateFormatter},
	                ]],
	                onResize:function(){
	...
	function filter()
	{
		...
		// console.log(data);
	  	...
	  	var dg = $(tabel_utama).datagrid({
			url : "<?php echo base_url("pembelian/laporan/permintaan_barang_farmasi/filter"); ?>",
			method: "POST",
			queryParams: data,
	...
	function cetak()
	{
	    ...
	    $.ajax({
	        url     : "<?= base_url() ?>pembelian/laporan/permintaan_barang_farmasi/cetak_"+url,
	        type    : "POST",
	    	dataType: 'json',	
	        data:data,
	...
	function set_form()
	{
		...
		var url_control = "<?= base_url() ?>pembelian/laporan/permintaan_barang_farmasi/cetak_"+url;

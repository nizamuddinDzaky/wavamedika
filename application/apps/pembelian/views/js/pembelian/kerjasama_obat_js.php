<script type="text/javascript">
    ...
    function btn_ubah()
    {
        var row = $('#dtg-kerjasama_obat').datagrid('getSelected');
        if(row <= 0)
        {
            notif('warning','Data Belum Di pilih');
            return false;
    ...
    {
        $.ajax({
            url     : "<?php echo base_url("pembelian/pembelian/Kerjasama_obat/getKerjasama"); ?>",
            type    : "POST",
            dataType: 'json',
            data    :{
                data:no,
    ...
    {   
        ...
        $('#loader').css('display','');
        $.ajax({
          url : "<?php echo base_url('pembelian/pembelian/Kerjasama_obat/simpan'); ?>",
          type: "POST",
          dataType: 'json',
          data:{
            master    : master,
    ...
    function filter()
    {
        $('#dtg-kerjasama_obat').datagrid('loadData', []);
        ...
        var dg = $('#dtg-kerjasama_obat').datagrid({
          url : "<?php echo base_url("pembelian/pembelian/Kerjasama_obat/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_barang()
    {
        ...
        var dg = $('#dtg-barang').datagrid({
          url : "<?php echo base_url("pembelian/pembelian/Kerjasama_obat/filter_barang"); ?>",
          method: "POST",
          queryParams: data,
          loadFilter: function(data) {
            return {
    ...
    function filter_produsen()
    {
        ...
        $.ajax({
          url : "<?php echo base_url("pembelian/pembelian/Kerjasama_obat/filter_produsen"); ?>",
          type: "POST",
          dataType: 'json',
          data:data,
          beforeSend: function (){               
    ...
    function hapus()
    {
        ...
        swal.fire(cohapus()).then(function(result) {
          if (result.value) {
            $.ajax({
                url     : "<?php echo base_url("pembelian/pembelian/Kerjasama_obat/hapus"); ?>",
                type    : "POST",
                dataType: 'json',
                data    :{
                    data: data,
    ...
    function cetak()
    {
        ...
        $.ajax({
            url     : "<?= base_url() ?>pembelian/pembelian/Kerjasama_obat/cetak",
            type    : "POST",
            dataType: 'json',   
            data:data,
            success:function(data, textStatus, jqXHR){
            if (data.success === true) {
              $('#loader').css('display','none');
                var file_cetak ='Laporan Kerjasama Pembelian Obat '+no_kerjasama_item+'.pdf';
    ...
    function set_excel()
    {
        ...
        var url_control = "<?= base_url() ?>pembelian/pembelian/Kerjasama_obat/cetak";
    ...
    function cek_data()
    {
        ...
        $.ajax({
            url     : "<?= base_url() ?>pembelian/pembelian/Kerjasama_obat/filter_cetak",
            type    : "POST",
            dataType: 'json',   
            data    :data,
            async : false,

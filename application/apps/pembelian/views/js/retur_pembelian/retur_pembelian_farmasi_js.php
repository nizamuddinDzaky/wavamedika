<script type="text/javascript">
    ...
    function filter(){
        ...
        var dg = $('#dtg-retur_pembelian').datagrid({
          url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_farmasi/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_supplier(){
        ...
        var dg = $('#dtg-supplier').datagrid({
			url        : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_farmasi/filter_supplier"); ?>",
			method     : "POST",
			queryParams: data,
			loadFilter : function(data) {
            return {
	...
	function filter_bpb() {
        ...
        var dg = $('#dtg-filter_barang').datagrid({
			url        : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_farmasi/filter_barang"); ?>",
			method     : "POST",
			queryParams: data,
			loadFilter : function(data) {
            return {
	...
	function simpan() {
        ...
        $.ajax({
			url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_farmasi/simpan"); ?>",
			type: "POST",
			dataType: 'json',
			data:{
				master: master,
    ...
    function getData(no_rt_pb){
      $.ajax({
        url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_farmasi/getPerKode"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: no_rt_pb,
    ...
    function verifikasi(data,status) {
        ...
        $.ajax({
            url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_farmasi/status"); ?>",
            type: "POST",
            dataType: 'json',
            data:{
                data: data,
    ...
    function hapus() {
		...
		swal.fire(cohapus()).then(function(result) {
			if (result.value) {
				$.ajax({
					url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_farmasi/hapus"); ?>",
					type: "POST",
					dataType: 'json',
					data:{
						data: data,
    ...
    function cetak(){
        ...
        $.ajax({
            url     : "<?= base_url() ?>pembelian/retur_pembelian/Retur_pembelian_farmasi/cetak",
            type    : "POST",
            dataType: 'json', 
            data    : data_cetak,
            success:function(data, textStatus, jqXHR){
            if (data.success === true) {
                ...
                let file_cetak = "Laporan_Retur_Pembelian_Farmasi.pdf";

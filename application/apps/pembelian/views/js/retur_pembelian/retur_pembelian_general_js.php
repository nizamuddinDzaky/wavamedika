<script type="text/javascript">
    ...
    function filter(){
        ...
        var dg = $('#dtg-retur_pembelian').datagrid({
          url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_general/filter"); ?>",
          method: "POST",
          queryParams: data,
    ...
    function filter_supplier(){
        ...
        var dg = $('#dtg-supplier').datagrid({
			url        : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_general/filter_supplier"); ?>",
			method     : "POST",
			queryParams: data,
			loadFilter : function(data) {
            return {
	...
	function filter_bpb() {
        ...
        var dg = $('#dtg-filter_barang').datagrid({
			url        : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_general/filter_barang"); ?>",
			method     : "POST",
			queryParams: data,
			loadFilter : function(data) {
            return {
	...
	function simpan() {
        ...
        $.ajax({
			url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_general/simpan"); ?>",
			type: "POST",
			dataType: 'json',
			data:{
				master: master,
    ...
    function getData(no_rt_pb){
      $.ajax({
        url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_general/getPerKode"); ?>",
        type: "POST",
        dataType: 'json',
        data:{
          data: no_rt_pb,
    ...
    function verifikasi(data,status) {
        ...
        $.ajax({
            url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_general/status"); ?>",
            type: "POST",
            dataType: 'json',
            data:{
                data: data,
    ...
    function hapus() {
		...
		swal.fire(cohapus()).then(function(result) {
			if (result.value) {
				$.ajax({
					url : "<?php echo base_url("pembelian/retur_pembelian/retur_pembelian_general/hapus"); ?>",
					type: "POST",
					dataType: 'json',
					data:{
						data: data,

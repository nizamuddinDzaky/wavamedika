...
class TCPDF_STATIC {
	...
	* @since 5.9.121 (2011-09-28)
	...
	public static function fopenLocal($filename, $mode) {
		...
		// return fopen($_SERVER['DOCUMENT_ROOT'].'wavamedika/'.$filename, $mode);
		return fopen($_SERVER['DOCUMENT_ROOT'].NAMA_PROYEK.'/'.$filename, $mode);
	}
	...
	public static $page_formats = array(
		...
		'ERESEP'	             => array(   935.43,   467.716), // = (   33 x 16.5 ) mm  = (  0.59 x 0.87  ) in
		'NOTA'	                 => array(   935.43,   269.290), // = (   33 x 9.5 ) mm  = (  0.59 x 0.87  ) in
		'GASMED'	             => array(  396.848,   269.290), // = (   14 x 9.5 ) mm  = (  0.59 x 0.87  ) in
